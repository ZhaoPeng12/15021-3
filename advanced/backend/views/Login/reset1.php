...
<section class="content_box" id="findPwd2">
    ...
    <div class="findPwd">
        ...
        <form action="?r=login/resett" method="post">
            <ul class="form_head clearfix">
                ...
                <li style="width:59px">
                    <span class="icon_step step"><img src="images/step3-active_e5df0e1.png" alt=""></span>
                    <span style="font-weight:bold; color: #0f0f0f">重置密码</span>
                </li>
            </ul>

            <div class="form_body" >
                <div class="input_item clearfix">
                    <input type="password" class="input input_white" id="" name="password" placeholder="请输入新密码" data-required="required" autocomplete="off" >
                </div>
                <div class="input_item clearfix">
                    <input type="password" class="input input_white" id="" name="password1" placeholder="请再次输入新密码" data-required="required" autocomplete="off" >
                </div>
                <div class="input_item clearfix">
                    <input type="text" class="input input_white" id="" name="num" placeholder="请输入验证码" data-required="required" autocomplete="off" >
                </div>
                <div class="input_item clearfix">
                    <input type="submit" class="btn btn_green btn_active btn_block" value="确定" id="step3" onclick="findByMail('step3')">
                </div>
            </div>
        </form>
    </div>
