...
<!--            			</span>-->
            		...
            		<div class="basicEdit dn">
            			<form id="profileForm" action="?r=order/information" method="post">
						  <table>
						    <tbody><tr>
						      <td valign="top">
						    ...
						    <tr>
						      ...
						      <td>
								  ...
								  <div class="boxUpDown boxUpDown_190 dn" id="box_workyear" style="">
						          	 <ul>
						        								        			<li>应届毕业生</li>
						        								        			<li>1年</li>
						        								        			<li>2年</li>
						    ...
						    <tr>
						      ...
						      <td colspan="3">
								  ...
								  <div class="boxUpDown boxUpDown_410 dn" id="box_currentState" style="">
						          	  <ul>
						        								        			<li>我目前已离职，可快速到岗</li>
            	...
            	<div class="profile_box" id="expectJob">
            		...
            		<div class="expectEdit dn">
            			<form id="expectForm" action="?=rorder/expectedwork
" method="post">
	            			<table>
	            				<tbody><tr>
	            					<td>
	            						<input type="hidden" id="expectCity" value="" name="expectCity">
																				...
																				<div class="boxUpDown boxUpDown_596 dn" id="box_expectCity" style="">
								          									        		<dl>
								        			<dt>热门城市</dt>
								        			<dd>
									        												        				<span>北京</span>
	            				...
	            				<tr>
	            					...
	            					<td>
	            						<input type="hidden" id="expectSalary" value="" name="expectSalary">
	            													        	...
	            													        	<div class="boxUpDown boxUpDown_287 dn" id="box_expectSalary" style="">
								          	  <ul>
								        										        			<li>2k以下</li>
								        										        			<li>2k-5k</li>
								        										        			<li>5k-10k</li>
            	...
            	<div class="profile_box" id="workExperience">
            		...
            		<div class="experienceShow dn">
            		            			<form  action="?r=order/experience" method="post">
	            			<table>
	            				<tbody><tr>
							      	<td valign="top">
							        	<span class="redstar">*</span>
	            				...
	            				<tr>
	            					...
	            					<td>
		            					<div class="fl">
											...
											<div class="box_companyYearStart boxUpDown boxUpDown_139 dn" style="">
									            <ul>
									        											        			<li>2014</li>
									        											        			<li>2013</li>
									        											        			<li>2012</li>
            	...
            	<div class="profile_box" id="projectExperience">
            		...
            		<div class="projectEdit dn">
            			<form  action="?r=order/subject" method="post">
	            			<table>
	            				<tbody><tr>
	            					<td valign="top">
							        	<span class="redstar">*</span>
            	...
            	<div class="profile_box" id="educationalBackground">
            		...
            		<div class="educationalShow dn">
            		            			<form  action="?r=order/education" method="post">
	            			<table>
	            				<tbody><tr>
							      	<td valign="top">
							        	<span class="redstar">*</span>
            	...
            	<div class="profile_box" id="selfDescription">
            		...
            		<div class="descriptionEdit dn">
            			<form  action="?r=order/selfdescription" method="post">
	            			<table>
	            				<tbody><tr>
									<td colspan="2">
            	...
            	<div class="profile_box" id="worksShow">
            		...
            		<div class="workEdit dn">
            			<form  action="?r=order/show" method="post">
	            			<table>
	            				<tbody><tr>
							      	<td>
...
<div id="cboxOverlay" style="display: none;"></div><div id="colorbox" class="" role="dialog" tabindex="-1" style=""><div id="cboxWrapper"><div><div id="cboxTopLeft" style="float: left;"></div><div id="cboxTopCenter" style="float: left;"></div><div id="cboxTopRight" style="float: left;"></div></div><div style="clear: left;"><div id="cboxMiddleLeft" style="float: left;"></div><div id="cboxContent" style="float: left;"><div id="cboxTitle" style="float: left;"></div><div id="cboxCurrent" style="float: left;"></div><button type="button" id="cboxPrevious"></button><button type="button" id="cboxNext"></button><button id="cboxSlideshow"></button><div id="cboxLoadingOverlay" style="float: left;"></div><div id="cboxLoadingGraphic" style="float: left;"></div></div><div id="cboxMiddleRight" style="float: left;"></div></div><div style="clear: left;"><div id="cboxBottomLeft" style="float: left;"></div><div id="cboxBottomCenter" style="float: left;"></div><div id="cboxBottomRight" style="float: left;"></div></div></div><div style="position: absolute; width: 9999px; visibility: hidden; "></div></div></body></html>