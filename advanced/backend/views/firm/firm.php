    ...
    <div id="container">
        ...
        <div class="content_mid">
            <dl class="c_section c_section_mid">
                ...
                <dd>
                    <form id="stepForm" action="?r=firm/firm_do" method="post">
                        ...
                        <h3>公司全称</h3>
                        <input type="text" name="f_text" placeholder="请输入公司全称" value="" id="f_text" class="valid">
                        <h3>公司简称</h3> <!--非必填-->
                        <input type="text" placeholder="请输入公司简称，如:拉勾" value="" name="f_name" id="f_name" class="valid">
...
<!--                                    大小：小于5M-->
<!--                                </div>-->
<!--                                <div class="dn" id="logoShow" name="f_logo">-->
...
<!--                        </div>-->
                        ...
                        <h3>公司网址</h3>
                        <input type="text" placeholder="请输入公司网址" value="" name="f_http" id="f_http">

                        <h3>所在城市</h3>
                        <input type="text" placeholder="请输入工作城市，如：北京" name="f_city" id="f_city">
...
<!--                            <div class="dn" id="box_industry" style="display: none;" >-->
                                <select name="f_industry" id="f_industry">
...
<!--                            </div>-->
                        ...
                        <div>
                            ...
                            <input type="button" value="请选择公司规模" id="select_scale" class="select">
                                ...
                                <select name="f_scale" id="f_scale">
                        ...
                        <div>
                            ...
                            <input type="radio" name="f_devle" value="1" width="100px">未融资
                            <input type="radio" name="f_devle" value="2"  width="100px">天使轮
                            <input type="radio" name="f_devle" value="3"  width="100px">A轮
                            <input type="radio" name="f_devle" value="4"  width="100px">B轮
                            <input type="radio" name="f_devle" value="5"  width="100px">C轮
                            <input type="radio" name="f_devle" value="6"  width="100px">D轮及以上
                            <input type="radio" name="f_devle" value="7"  width="100px">上市公司
...
<!--                                <div class="box_invest dn" style="display: none;" name="">-->
<!--                                    <ul class="reset">-->
<!--                                        <li>天使轮</li>-->
<!--                                        <li>A轮</li>-->
<!--                                        <li>B轮</li>-->
...
<!--                        </div>-->
                        ...
                        <h3>一句话介绍</h3>
                        <input type="text" placeholder="一句话概括公司亮点，如公司愿景、领导团队等，限50字" maxlength="50" name="f_generalize" id="f_generalize">
