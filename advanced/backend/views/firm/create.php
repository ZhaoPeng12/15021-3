...
<div id="body">
    <div id="header">
        <div class="wrapper">
            ...
            <dl class="collapsible_menu">
                ...
                <dd style="display: none;"><a href="?r=firm/positions">我发布的职位</a></dd>
                <dd style="display: none;"><a href="?r=firm/po">我收到的简历</a></dd>
                <dd class="btm" style="display: none;"><a href="myhome.html">我的公司主页</a></dd>
                <dd style="display: none;"><a href="jianli.html">我要找工作</a></dd>
                <dd style="display: none;"><a href="?r=login/account">帐号设置</a></dd>
    ...
    <div id="container">
        ...
        <div class="sidebar">
            <a class="btn_create" href="?r=index/create">发布新职位</a>
            <dl class="company_center_aside">
                <dt>我收到的简历</dt>
                <dd>
                    <a href="?r=firm/create">待处理简历</a>
                </dd>
                <dd>
                    <a href="?r=firm/can">待定简历</a>
                </dd>
                <dd>
                    <a href="?r=firm/notice">已通知面试简历</a>
                </dd>
                <dd>
                    <a href="?r=firm/haves">不合适简历</a>
                </dd>
                <dd class="btm">
                    <a href="?r=firm/auto">自动过滤简历</a>
                </dd>
            </dl>
            <dl class="company_center_aside">
                <dt>我发布的职位</dt>
                <dd>
                    <a href="?r=firm/posit">有效职位</a>
                </dd>
                <dd>
                    <a href="?r=firm/pos">已下线职位</a>
                </dd>
            </dl>
